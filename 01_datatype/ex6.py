...
for i in range(10):
    my_str += str(i)
    my_list.append(str(i))  # 매번 새로운 문자열 객체를 생성
end = time.time()

print(my_str)
print(f"실행 시간: {end - start:.12f}초")
...
# 문자열 언패킹도 가능
a, b, c, d, e, f = s  # p, y, t, h, o, n에 각각 저장
print(a, b, c, d, e, f)
...
s = "1318"
print(f"{s[0]}학년 {s[1]}반 {s[2]}{s[3]}번")  # ✅ "1학년 3반 18번" 출력

# 2️⃣ 학번을 슬라이싱만을 이용해서 학년, 반, 번호로 잘라내기
print(f"{s[:1]}학년 {s[1:2]}반 {s[2:4]}번")  # ✅ "1학년 3반 18번" 출력
